...
function PASS({ setStep, handleUpdate }: StepProps) {
  ...
  return (
    <VerticalFlex className={styles.auth_root_box}>
      ...
      <FlexChild justifyContent="center" width={'100%'} maxWidth={600} paddingTop={30}>
...
function SMS({ setStep, handleUpdate }: StepProps) {
  ...
  return (
    <VerticalFlex className={styles.auth_root_box}>
      ...
      <FlexChild justifyContent="center">
        <HorizontalFlex gap={7} width={'100%'} maxWidth={363} paddingTop={30}>
          {/* <FlexChild>
            <Button
              width={"100%"}
              className={clsx(styles.button, styles.white)}
  ...
  return (
    <VerticalFlex className={styles.wrapper}>
      <FlexChild alignItems="center" justifyContent="center">
        <P size={16} paddingBottom={25} color="#fff">
          {"회원님의 휴대전화로\n가입된 아이디입니다"}
        </P>
      </FlexChild>
      <FlexChild
      ...
      <FlexChild position="sticky" marginTop={"auto"} paddingTop={30}>
        <VerticalFlex>
          <Button
            className={clsx(styles.button, styles.next_btn)}
            width={'100%'}
