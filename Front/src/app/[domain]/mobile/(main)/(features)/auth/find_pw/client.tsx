...
export default function PwStepBox() {
  ...
  switch (step) {
    ...
    default:
      return (
        <FlexChild padding={50}>
          <VerticalFlex gap={20}>
            <Image src="/resources/images/error_icon.png" width={60} />
            <P color="#fff" paddingBottom={20} size={13}>
              알 수 없는 오류가 발생했습니다.
            </P>
            <FlexChild>
              <Button
...
function PASS({ setStep, handleUpdate }: StepProps) {
  ...
  return (
    <VerticalFlex className={styles.auth_root_box}>
      ...
      <FlexChild justifyContent="center" width={'100%'} maxWidth={600} paddingTop={20}>
        <HorizontalFlex gap={10} width={'100%'} maxWidth={363} className={styles.continue_box}>
          <FlexChild>
            <Button
              width={"100%"}
              className={clsx(styles.button, styles.next_btn)}
...
function SMS({ setStep, handleUpdate }: StepProps) {
  ...
  return (
    <VerticalFlex className={styles.auth_root_box}>
      ...
      <FlexChild justifyContent="center">
        <HorizontalFlex gap={7} width={'100%'} maxWidth={363} paddingTop={20}>
          {/* <FlexChild>
            <Button
              width={"100%"}
  ...
  return (
    <VerticalFlex className={styles.wrapper} >
      <FlexChild margin={"auto"} padding={37}>
        <VerticalFlex>
          <P paddingBottom={25} color="#fff" textAlign="center" lineHeight={'1.3'}>
            {"PASS앱에서 인증 후\n인증완료 버튼을 눌러주세요"}
          </P>
          <Image
      ...
      <FlexChild width={"100%"} maxWidth={500} gap={7} paddingTop={40}>
        <Button
...
function ChangePassword({ data, setStep }: StepProps) {
  ...
  return (
    <VerticalFlex className={styles.wrapper} >
      <FlexChild justifyContent="center" maxWidth={220}>
        <P size={14} wordBreak="break-all" paddingBottom={25} color="#fff" textAlign="center" lineHeight={'1.3'}>
          {"본인인증이 완료되었습니다\n비밀번호를 재설정해주세요"}
        </P>
      </FlexChild>
      <FlexChild
