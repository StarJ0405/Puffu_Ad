...
export default async function () {
  ...
  return (
    <section className='root'>
      <VerticalFlex>
         <FlexChild>
            <P className={style.title}>제1조(목적)</P>
            <VerticalFlex gap={5}>
               <P className={style.txt1}>
                  이 약관은 주식회사 월드베이프(전자상거래 사업자)가 운영하는 월드베이프 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리.의무 및 책임사항을 규정함을 목적으로 합니다.
         ...
         <FlexChild>
            <P className={style.title}>제2조(정의)</P>
            <VerticalFlex gap={5}>
               <P className={style.txt1}>
                  ① “몰”이란 월드베이프가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
         ...
         <FlexChild>
            <P className={style.title}>제3조 (약관 등의 명시와 설명 및 개정)</P>
            <VerticalFlex gap={5}>
               <P className={style.txt1}>
         ...
         <FlexChild>
            <P className={style.title}>제4조(서비스의 제공 및 변경)</P>
            <VerticalFlex gap={5}>
               <P className={style.txt1}>
         ...
         <FlexChild>
          ...
          <FlexChild>
            <P className={style.title}>제5조(서비스의 중단)</P>
            <VerticalFlex gap={5}>
               <P className={style.txt1}>
...
부 칙(시행일) 이 약관은 2025년 01월 02일부터 시행합니다.
      제1조(목적)
