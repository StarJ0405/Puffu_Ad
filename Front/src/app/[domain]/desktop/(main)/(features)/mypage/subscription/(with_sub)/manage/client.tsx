            ...
            <VerticalFlex className={styles.item_content}>
              ...
              <VerticalFlex className={styles.unit} alignItems="start">
                <FlexChild>
                  ...
                  />
                  <P>
                    전제품 <Span verticalAlign={'baseline'}>{(plan?.percent || 0).toLocaleString("ko-KR")}% 상시 할인</Span>
                  </P>
                </FlexChild>
                ...
                <FlexChild>
                  ...
                  />
                  <P>
                    매월 프리 머니 <Span verticalAlign={'baseline'}>{(plan?.value || 0).toLocaleString("ko-KR")}원</Span> 쿠폰 지급
                  </P>
                </FlexChild>
              </VerticalFlex>
            </VerticalFlex>

            <P className={styles.payment_txt}>수동 결제 / 연 {Number(plan?.price ?? 49800).toLocaleString("ko-KR")}원</P>
          </VerticalFlex>
