...
class _AdminRequester {
  ...
  async createContractFromTemplate(
    ...
    if (callback)
      callback(await this.post(`/contract/${id}?action=create`, data));
    else return await this.post(`/contract/${id}?action=create`, data);
  }
  ...
  // 계약 완료 처리
  async completeContract(id: string, callback?: Function): Promise<any> {
    if (callback)
      callback(await this.post(`/contract/${id}?action=complete`, {}));
    else return await this.post(`/contract/${id}?action=complete`, {});
  }

  // 계약 삭제
  async deleteContract(id: string, callback?: Function): Promise<any> {
