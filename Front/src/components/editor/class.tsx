...
export abstract class AddOn {
  ...
  private static createBlotClass(): typeof Embed {
    ...
    return class Dynamicblot extends Embed {
      ...
      format(name: string, value: any): void {
        _format?.(this.domNode, name, value);
      }
    };
  }
  // module 정의
  static handleInsert(quill: any): void {}
  private static createModuleClass(): typeof import("quill").Module {
    const name = this._name;
  ...
  static register(RQ: typeof ReactQuill): void {
    const blot = this.createBlotClass();
