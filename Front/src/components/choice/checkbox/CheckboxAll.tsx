...
const CheckboxAll = forwardRef<HTMLInputElement, CheckboxAllProps>(
  ({ id, className, style, children, onChange, images, ...rest }, ref) => {
    ...
    const backgroundImage = useMemo(() => {
      ...
      return "none";
    }, [allChecked, isHovered, hasImages, currentImages, isBackgroundImage]);
    ...
    return (
      <div
        ...
        style={{
          ...
          width: hasImages ? "20px" : undefined,
          height: hasImages ? "20px" : undefined,
          cursor: "pointer",
      ...
      >
        ...
        {!isBackgroundImage &&
          hasImages &&
          (allChecked ? currentImages.on : currentImages.off)}
      </div>
    );
  }
);
