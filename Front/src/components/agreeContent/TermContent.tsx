...
export default function TermContent({size = 10} : Props) {
  return (
    <VerticalFlex className={styles.board_container} fontSize={size}>
      ...
      <VerticalFlex>
        <P className={styles.title}>제1조(목적)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
            이 약관은 주식회사 푸푸글로벌(전자상거래 사업자)가 운영하는
            푸푸글로벌 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련
      ...
      <VerticalFlex>
        <P className={styles.title}>제2조(정의)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
            ① “몰”이란 푸푸글로벌가 재화 또는 용역(이하 “재화 등”이라 함)을
      ...
      <VerticalFlex>
        <P className={styles.title}>제3조(약관 등의 명시와 설명 및 개정)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
      ...
      <VerticalFlex>
        <P className={styles.title}>제4조(서비스의 제공 및 변경)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>① “몰”은 다음과 같은 업무를 수행합니다.</P>
          <P className={styles.txt1}>
          ...
          <P className={styles.txt1}>3. 기타 “몰”이 정하는 업무</P>
          <P className={styles.txt1}>
      ...
      <VerticalFlex>
        <P className={styles.title}>제5조(서비스의 중단)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
      ...
      <VerticalFlex>
        <P className={styles.title}>제6조(회원가입)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
      ...
      {/* 제8조 */}
      <VerticalFlex>
        <P className={styles.title}>제8조(회원에 대한 통지)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
      ...
      {/* 제9조 */}
      <VerticalFlex>
        <P className={styles.title}>제9조(구매신청)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
          ...
          <P className={styles.txt1}>1. 재화 등의 검색 및 선택</P>
          <P className={styles.txt1}>
          ...
          <P className={styles.txt1}>6. 결제방법의 선택</P>
          <P className={styles.txt1}>
            ② “몰”이 제3자에게 구매자 개인정보를 제공·위탁할 필요가 있는 경우
            실제 구매신청 시 구매자의 동의를 받아야 하며, 회원가입 시 미리
            포괄적으로 동의를 받지 않습니다. 이 때 “몰”은 제공되는 개인정보
            항목, 제공받는 자, 제공받는 자의 개인정보 이용 목적 및 보유·이용
            기간 등을 구매자에게 명시하여야 합니다. 다만 「정보통신망이용촉진 및
            정보보호 등에 관한 법률」 제25조 제1항에 의한 개인정보 처리위탁의
            경우 등 관련 법령에 달리 정함이 있는 경우에는 그에 따릅니다.
          </P>
        </VerticalFlex>
      </VerticalFlex>

      <VerticalFlex>
        <P className={styles.title}>제10조 (계약의 성립)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
          ...
          <P className={styles.txt1}>
            2. 기타 구매신청에 승낙하는 것이 “몰” 기술상 현저히 지장이 있다고
            판단하는 경우
          </P>
          <P className={styles.txt1}>
      ...
      {/* 제11조 */}
      <VerticalFlex>
        <P className={styles.title}>제11조(지급방법)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
          ...
          <P className={styles.txt1}>3. 온라인무통장입금</P>
          <P className={styles.txt1}>4. 전자화폐에 의한 결제</P>
          <P className={styles.txt1}>5. 수령 시 대금지급</P>
          <P className={styles.txt1}>
      ...
      {/* 제13조 */}
      <VerticalFlex>
        <P className={styles.title}>제13조(재화 등의 공급)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
      ...
      {/* 제14조 */}
      <VerticalFlex>
        <P className={styles.title}>제14조(환급)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
      ...
      {/* 제15조 */}
      <VerticalFlex>
        <P className={styles.title}>제15조(청약철회 등)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
      ...
      {/* 제16조 */}
      <VerticalFlex>
        <P className={styles.title}>제16조(청약철회 등의 효과)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
      ...
      {/* 제17조 */}
      <VerticalFlex>
        <P className={styles.title}>제17조(개인정보보호)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
          ...
          <P className={styles.txt1}>
            ...
            개인정보보호 책임자의 신원(소속, 성명 및 전화번호, 기타 연락처),
          ...
          <P className={styles.txt1}>
            ⑦ “몰”은 개인정보 보호를 위하여 이용자의 개인정보를 처리하는 자를
      ...
      {/* 제18조 */}
      <VerticalFlex>
        <P className={styles.title}>제18조(“몰“의 의무)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
      ...
      {/* 제20조 */}
      <VerticalFlex>
        <P className={styles.title}>제20조(이용자의 의무)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
            이용자는 다음 행위를 하여서는 안 됩니다.
          </P>
          <P className={styles.txt1}>1. 신청 또는 변경시 허위 내용의 등록</P>
          <P className={styles.txt1}>2. 타인의 정보 도용</P>
          <P className={styles.txt1}>3. “몰”에 게시된 정보의 변경</P>
          <P className={styles.txt1}>
      ...
      {/* 제21조 */}
      <VerticalFlex>
        <P className={styles.title}>제21조(연결“몰”과 피연결“몰” 간의 관계)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
      ...
      {/* 제22조 */}
      <VerticalFlex>
        <P className={styles.title}>제22조(저작권의 귀속 및 이용제한)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
      ...
      {/* 제23조 */}
      <VerticalFlex>
        <P className={styles.title}>제23조(분쟁해결)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
      ...
      <VerticalFlex>
        <P className={styles.title}>제24조(재판권 및 준거법)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
      ...
      <VerticalFlex>
        <P className={styles.title}>부칙(시행일)</P>
        <VerticalFlex gap={5}>
          <P className={styles.txt1}>
            이 약관은 2025년 01월 02일부터 시행합니다.
          </P>
        </VerticalFlex>
      </VerticalFlex>
    </VerticalFlex>
